// routes/home.js — POLISHED VERSION
...
<link href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,400;0,600;0,700;1,400;1,700&family=DM+Sans:wght@300;400;500;600;700&family=DM+Serif+Display:ital@0;1&display=swap" rel="stylesheet"/>
...
<div class="ticker-bar">
  ...
  <div class="ticker-track">
    <span class="ticker-item">🎄 Christmas Markets season — discover the best across Europe this winter</span>
    ...
    <span class="ticker-dot">●</span>
    <span class="ticker-item">🌍 ${stats.events}+ events live across 11 countries worldwide</span>
    <span class="ticker-dot">●</span>
    <span class="ticker-item">📰 ${stats.articles} festival guides published — new articles every day</span>
    <span class="ticker-dot">●</span>
    <span class="ticker-item">🏪 ${stats.vendors}+ verified vendors ready to join your event</span>
    <span class="ticker-dot">●</span>
    <span class="ticker-item">🎄 Christmas Markets season — discover the best across Europe this winter</span>
    <span class="ticker-dot">●</span>
    <span class="ticker-item">🎵 Copenhagen Jazz Festival — 1,000+ concerts across 130 venues</span>
    ...
    <div class="hero-right">
      ...
      <div class="hero-imgs-small">
        ...
        <div class="hero-img-sm">
          ...
          <span class="hero-img-label">🛍️ Markets</span>
        </div>
      </div>
    </div>
  </div>
...
<div class="stats-strip">
  <div class="stats-strip-inner">
    ...
    <div class="strip-div"></div>
    <div class="strip-stat"><span class="strip-stat-n">${stats.articles}+</span><span class="strip-stat-l">Festival Articles</span></div>
    <div class="strip-div"></div>
    ...
    <div class="cats-grid">
      ${Object.entries(CATS).map(([k,icon]) => {
        ...
        return `<a href="/events?category=${k}" class="cat-card">
          ...
          <span class="cat-name">${CAT_LABELS[k]}</span>
    ...
    <div class="articles-grid">
      ${articles.map(a => `
        <a href="/articles/${a.slug}" class="article-card">
          <div class="article-img"><img src="${a.image_url || IMGS.festival}" alt="${a.title}" loading="lazy"/></div>
  ...
  <div class="container">
    <div class="cta-inner">
      <div class="cta-left">
        ...
        <p>List your festival, market, concert or event on Festmore and reach thousands of visitors worldwide. Basic listings from just €79/year.</p>
      ...
      <div class="cta-right">
        ...
        <div class="cta-stat"><span>🔍</span> SEO-optimised listing with your own URL</div>
        <div class="cta-stat"><span>🏪</span> Connect with ${stats.vendors}+ verified vendors</div>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="newsletter-box">
      <div class="newsletter-left">
        ...
        <p>Get the best festivals and events delivered to your inbox every week. Join ${stats.subscribers.toLocaleString()}+ subscribers already signed up.</p>
      </div>
...
document.getElementById('newsletter-form')?.addEventListener('submit', async e => {
  ...
  if (json.ok) {
    e.target.innerHTML = '<p style="color:#4a7c59;font-weight:700;font-size:16px;text-align:center;padding:20px 0;">✅ You\'re subscribed! Welcome to Festmore.</p>';
  } else {
    alert(json.msg);
  }
});
