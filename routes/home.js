  ...
  <div style="max-width:1200px;margin:0 auto;display:grid;grid-template-columns:1fr auto;gap:48px;align-items:center;position:relative;z-index:1;">
    <div>
      ...
      <div style="display:flex;gap:12px;flex-wrap:wrap;align-items:center;">
        ...
        <a href="/list-christmas" style="display:inline-flex;align-items:center;gap:8px;background:linear-gradient(135deg,rgba(212,160,23,.2),rgba(212,160,23,.08));color:#d4a017;border:1px solid rgba(212,160,23,.4);padding:14px 28px;border-radius:10px;font-size:14px;font-weight:700;text-decoration:none;">List Your Market — €29 →</a>
      </div>
