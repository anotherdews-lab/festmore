  ...
  try {
    ...
    await resend.emails.send({
      ...
      html: '<!DOCTYPE html><html><head><meta charset="UTF-8"/></head>'
        ...
        + '</tr></table>'
        + (plan === 'free' ? '<table width="100%" cellpadding="0" cellspacing="0" style="background:linear-gradient(135deg,#1a0800,#2d1200);border-radius:16px;margin-bottom:24px;"><tr><td style="padding:28px 32px;"><div style="display:inline-block;background:rgba(232,71,10,.2);border:1px solid rgba(232,71,10,.4);border-radius:99px;padding:4px 14px;margin-bottom:14px;"><span style="color:#ff8c5a;font-size:11px;font-weight:700;letter-spacing:1px;text-transform:uppercase;">Featured Listing - 79 EUR per year</span></div><h3 style="font-size:20px;color:#fff;margin:0 0 10px;font-family:Georgia,serif;">One booking from Festmore covers your listing for life.</h3><p style="font-size:13px;color:rgba(255,255,255,.55);line-height:1.7;margin:0 0 18px;">Your event is live - but Featured organisers appear at the top of every search, on the Festmore homepage and in our weekly newsletter to 500+ vendors and event professionals across 42 countries. Most Featured events receive their first vendor application within 7 days.</p><table width="100%" cellpadding="5" cellspacing="0" style="margin:0 0 20px;"><tr><td width="50%" style="font-size:13px;color:rgba(255,255,255,.7);">Top of all search results</td><td width="50%" style="font-size:13px;color:rgba(255,255,255,.7);">Homepage placement</td></tr><tr><td width="50%" style="font-size:13px;color:rgba(255,255,255,.7);">Weekly newsletter inclusion</td><td width="50%" style="font-size:13px;color:rgba(255,255,255,.7);">Featured badge on listing</td></tr><tr><td width="50%" style="font-size:13px;color:rgba(255,255,255,.7);">Priority vendor applications</td><td width="50%" style="font-size:13px;color:rgba(255,255,255,.7);">SEO-optimised listing page</td></tr></table><div style="text-align:center;"><a href="https://festmore.com/events/pricing" style="display:inline-block;background:linear-gradient(135deg,#e8470a,#c73d08);color:#fff;padding:14px 36px;border-radius:10px;font-size:15px;font-weight:700;text-decoration:none;">Get Featured - 79 EUR per year</a><p style="font-size:11px;color:rgba(255,255,255,.3);margin:10px 0 0;">Secure payment via Stripe - One vendor booking pays for the whole year</p></div></td></tr></table>' : '')
