...
router.post('/register', express.json(), async (req, res) => {
  ...
  try {
    ...
    // Notify admin + welcome email to artist
    try {
      ...
      await resend.emails.send({
        ...
        html: '<p><b>' + name + '</b> just listed on Festmore Artists.</p><p>Genre: ' + genre + ' | City: ' + city + ', ' + country + '</p><p>Email: ' + email + '</p><p><a href="https://festmore.com/artists/' + slug + '">View profile</a></p>'
      });
      await resend.emails.send({
        from: 'Festmore <hello@festmore.com>',
        to: email,
        subject: "You're live on Festmore - your artist profile is ready",
        html: '<!DOCTYPE html><html><head><meta charset="UTF-8"/></head><body style="margin:0;padding:0;background:#f5f0e8;font-family:Helvetica,Arial,sans-serif;"><table width="100%" cellpadding="0" cellspacing="0" style="background:#f5f0e8;padding:40px 20px;"><tr><td align="center"><table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;"><tr><td style="background:#080514;border-radius:20px 20px 0 0;padding:48px;text-align:center;"><div style="margin-bottom:20px;"><span style="font-size:26px;font-weight:800;"><span style="color:#fff;">Fest</span><span style="color:#e8470a;">more</span></span></div><div style="display:inline-block;background:rgba(107,63,160,.2);border:1px solid rgba(107,63,160,.4);border-radius:99px;padding:6px 16px;margin-bottom:20px;"><span style="color:#b08de0;font-size:12px;font-weight:700;letter-spacing:1px;text-transform:uppercase;">Artist Profile Live</span></div><h1 style="font-size:32px;font-weight:400;color:#fff;margin:0 0 12px;font-family:Georgia,serif;">Welcome to Festmore, ' + name + '!</h1><p style="font-size:15px;color:rgba(255,255,255,.55);margin:0;line-height:1.6;">Your artist profile is now live and discoverable by event organisers across 42 countries.</p></td></tr><tr><td style="background:#fff;padding:40px 48px;"><h2 style="font-size:20px;color:#1a1208;margin:0 0 16px;font-family:Georgia,serif;">Your profile is ready</h2><p style="font-size:14px;color:#6b5f58;line-height:1.7;margin:0 0 20px;">Event organisers searching for ' + genre + ' artists can now find and contact you directly.</p><div style="text-align:center;margin:0 0 28px;"><a href="https://festmore.com/artists/' + slug + '" style="display:inline-block;background:#6b3fa0;color:#fff;padding:14px 32px;border-radius:10px;font-size:15px;font-weight:700;text-decoration:none;">View Your Profile</a></div><table width="100%" cellpadding="12" cellspacing="0" style="background:#f5f0e8;border-radius:12px;margin:0 0 28px;"><tr><td style="border-bottom:1px solid #e8e0d5;font-size:13px;color:#6b5f58;"><b style="color:#1a1208;">Genre:</b> ' + genre + '</td></tr><tr><td style="border-bottom:1px solid #e8e0d5;font-size:13px;color:#6b5f58;"><b style="color:#1a1208;">Location:</b> ' + city + ', ' + country + '</td></tr><tr><td style="font-size:13px;color:#6b5f58;"><b style="color:#1a1208;">Profile:</b> festmore.com/artists/' + slug + '</td></tr></table><table width="100%" cellpadding="0" cellspacing="0" style="background:linear-gradient(135deg,#080514,#120a24);border-radius:16px;margin:0 0 24px;"><tr><td style="padding:28px 32px;"><div style="display:inline-block;background:rgba(107,63,160,.3);border:1px solid rgba(107,63,160,.5);border-radius:99px;padding:4px 14px;margin-bottom:14px;"><span style="color:#b08de0;font-size:11px;font-weight:700;letter-spacing:1px;text-transform:uppercase;">Verified Artist - 29 EUR per year</span></div><h3 style="font-size:20px;color:#fff;margin:0 0 10px;font-family:Georgia,serif;">One booking covers the whole year.</h3><p style="font-size:13px;color:rgba(255,255,255,.55);line-height:1.7;margin:0 0 18px;">Your free profile gets you visible - but Verified artists appear first in search results, stand out with a badge, and get featured in our newsletter to 500+ event organisers. At less than 2.50 EUR a month, it is the most cost-effective way to get booked.</p><table width="100%" cellpadding="5" cellspacing="0" style="margin:0 0 20px;"><tr><td width="50%" style="font-size:13px;color:rgba(255,255,255,.7);">Verified badge on profile</td><td width="50%" style="font-size:13px;color:rgba(255,255,255,.7);">Priority in search results</td></tr><tr><td width="50%" style="font-size:13px;color:rgba(255,255,255,.7);">Up to 3 photos and video links</td><td width="50%" style="font-size:13px;color:rgba(255,255,255,.7);">Spotify, YouTube, SoundCloud</td></tr><tr><td width="50%" style="font-size:13px;color:rgba(255,255,255,.7);">Featured in newsletter</td><td width="50%" style="font-size:13px;color:rgba(255,255,255,.7);">Stand out from free profiles</td></tr></table><div style="text-align:center;"><a href="https://festmore.com/artists/pricing" style="display:inline-block;background:linear-gradient(135deg,#6b3fa0,#9b59d0);color:#fff;padding:14px 36px;border-radius:10px;font-size:15px;font-weight:700;text-decoration:none;">Get Verified - 29 EUR per year</a><p style="font-size:11px;color:rgba(255,255,255,.3);margin:10px 0 0;">Secure payment via Stripe - Less than a coffee per month</p></div></td></tr></table><div style="background:#f5f0e8;border-radius:12px;padding:20px;text-align:center;"><p style="font-size:13px;color:#6b5f58;margin:0 0 6px;">Share your profile with event organisers:</p><p style="font-size:14px;font-weight:700;color:#1a1208;margin:0;word-break:break-all;">festmore.com/artists/' + slug + '</p></div></td></tr><tr><td style="background:#0a1a0f;border-radius:0 0 20px 20px;padding:24px;text-align:center;"><p style="font-size:12px;color:rgba(255,255,255,.3);margin:0;">Festmore.com</p></td></tr></table></td></tr></table></body></html>'
      });
    } catch(e) { console.log('Artist email error:', e.message); }
...
router.post('/enquiry', express.json(), async (req, res) => {
  ...
  try {
    ...
    await resend.emails.send({
      from: 'Festmore Artists <hello@festmore.com>',
