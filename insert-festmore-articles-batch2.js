...
const { article6, article7, article8, article9, article10 } = require('./festmore-articles-batch2.js');
...
async function run() {
  ...
  const articles = [article6, article7, article8, article9, article10];
  ...
  await client.end();
  console.log('\nDone — 5 more articles live on Festmore');
}
